...
export const appErrorSchema = z.object({ code: errorCodeSchema, operation: z.string(), subjectId: z.string().uuid().nullable().optional(), message: z.string(), details: z.string().nullable().optional(), retryable: z.boolean() });
