...
type Props = { profileId: string; revision: number; status: ProjectStatus; runtimeReady: boolean; showLifecycleActions?: boolean };
type Confirmation = 'tear-down' | 'remove';

export function ActionMenu({ profileId, revision, status, runtimeReady, showLifecycleActions = true }: Props) {
